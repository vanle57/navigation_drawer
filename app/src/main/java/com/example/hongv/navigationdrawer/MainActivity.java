...
public class MainActivity extends AppCompatActivity
    ...
    //list search center
    private ListView search_center;
    private ArrayList<String> arrayCenter = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //list center for search tool
        search_center = (ListView) findViewById(R.id.search_center);

        arrayCenter.addAll(Arrays.asList(getResources().getStringArray(R.array.my_center)));

        adapter = new ArrayAdapter<String>(MainActivity.this, android.R.layout.simple_list_item_1, arrayCenter);
        search_center.setAdapter(adapter);
    }
